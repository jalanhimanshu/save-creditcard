...
def seed_data(conn):
    ...
    transfer_partners_data = [
        ...
        ('Amex MR (India)', 'Taj Vouchers', '2:1', 0.50),
        ...
        ('HDFC Reward Points', 'SmartBuy Flights', '1:1', 0.50),
        ('SBI Rewardz', 'Club Vistara', '1:1', 0.80),
        ('SBI Rewardz', 'Yatra/Cleartrip Vouchers', '1:1', 0.25),
        ...
        ('NeuCoins', 'Tata Neu App Flights/Groceries', '1:1', 1.00),
        ('HSBC Rewards', 'Accor Live Limitless', '2:1', 0.90),
        ('HSBC Rewards', 'Singapore Krisflyer', '2:1', 0.75),
        ('HSBC Rewards', 'Statement Credit', '1:1', 0.20),
        ('Yes Rewards', 'Rewardz Flight Bookings', '1:1', 0.25),
        ('Yes Rewards', 'Air India Maharaja', '10:1', 0.10),
        ('IndusInd Rewards', 'Club Vistara', '1:1', 0.80),
        ('IndusInd Rewards', 'Cash Credit (Indulge)', '1:1', 1.00),
        ('Adani Rewardz', 'Adani One Flights/Duty-Free', '1:1', 1.00),
        ('MyCash', 'MakeMyTrip Bookings', '1:1', 1.00),
        ('Scapia Coins', 'Scapia App Flights', '5:1', 0.20),
        ('Fuel Points', 'IndianOil Fuel Outlets', '1:1', 0.25),
        ('PVR Tickets', 'PVR Cinemas Box Office', '1 Ticket', 0.50),
        ('Swiggy Cashback', 'Swiggy App Credit', '1:1', 1.00),
        ('IDFC Rewards', 'Pay with Points', '1:1', 0.25),
        ('ICICI Rewards', 'Amazon Pay Vouchers', '1:1', 0.25),
        ('BOB Rewardz', 'Statement Credit', '1:1', 0.25),
        ('Equitas Rewards', 'Statement Credit', '1:1', 0.20),
        ('Cashback', 'Statement Credit', '1:1', 1.00)
    ]
